...
SECRET_KEY = 'django-insecure-h==p(mz%mm9tf30drro6np29$z&!)4(ah5#%t1_w%u3wecb!@_'
...
STATICFILES_DIRS = [
    BASE_DIR / 'static',
    BASE_DIR / 'node_modules/bootstrap/dist/css',  # Include Bootstrap CSS path
    BASE_DIR / 'node_modules/bootstrap/dist/js',   # Include Bootstrap JS path
